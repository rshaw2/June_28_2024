...
namespace June282024.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class June282024Context : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=june282024.database.windows.net;Initial Catalog=T423798_June_28_2024;Persist Security Info=True;user id=Lowcodeadmin;password=NtLowCode^123*;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
