...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "June282024", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<June282024Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "June282024 API v1");
